...
import numpy as np
import argparse
import imutils # library that we are going to write ourselves and create “convenience” methods to do common tasks like translation, rotation, and resizing.
import cv2
...
#always float bcs opencv expected to be float
