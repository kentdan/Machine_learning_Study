...
# cv2.add and cv2.subtract, values will be clipped to this (clipped) so the max 255 and min 0 (RGB)
...
# the values will be modulos (wrap around) instead of being (wrap and starts counting backwards from 255)
