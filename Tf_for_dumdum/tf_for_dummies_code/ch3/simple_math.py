...
quot1 = tf.truediv(const_a, const_b)
...
vec_a = tf.linspace(0.0, 3.0, 4) #last number is the line
vec_a
...
tf.print( 'Sum: %f' % total)
tf.print('Quotient: %f' % quot)
tf.print('Difference: ', diff)
tf.print('Element-wise product: ', prod)
tf.print('Dot product: ', dot)
tf.print('Matrix product: ', mat_prod)
